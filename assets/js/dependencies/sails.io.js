...
(function () {
    ...
    function SailsIOClient(io) {
        ...
        // when the browser connects with `io.connect()`, we create our own constructor,
        // `SailsSocket`. This makes our solution more future-proof and helps us work better w/ the
        // Socket.io team when changes are rolled out in the future.  To get a `SailsSocket`, you
        // can run: ``` io.sails.connect(); ```
         ...
         *
         * If no `socket` option is provied, SailsSocket will function as a mock. It will queue
         * socket requests and event handler bindings, replaying them when the raw underlying
         * socket actually connects. This is handy when we don't necessarily have the valid
         * configuration to know WHICH SERVER to talk to yet, etc.  It is also used by `io.socket`
        ...
        function SailsSocket(opts) {
            ...
            // Set up "eventQueue" to hold event handlers which have not been set on the actual raw
            // socket yet.
            self.eventQueue = {};
        ...
        SailsSocket.prototype._connect = function () {
            ...
            var isXOrigin = (function () {
                ...
                // If target hostname is different than actual hostname, we'll consider this
                // cross-origin.
            ...
            (function selfInvoking(cb) {
                ...
                self.on('connect', function socketConnected() {
                    ...
                    consolog.noPrefix(
                            ...
                            // '`io.socket.get("/foo", function serverRespondedWith (body, jwr) {
                            // console.log(body); })`'+ '\n' +
                    );
                });
     ...
     * });
        ...
        setTimeout(function () {
            ...
            // consolog('Eagerly auto-connecting socket to Sails... (requests will be queued in the
            // mean-time)');
            io.socket._connect();
